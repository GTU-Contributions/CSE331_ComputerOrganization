README!!!
- Instructions that you have to implement: 
sw, lw, beq, j, add, andi, slt, slti

- Top Level Design File: mips_core
- You cannot use the behavioral verilog in mips_core. However, you are allowed to use "assign".
